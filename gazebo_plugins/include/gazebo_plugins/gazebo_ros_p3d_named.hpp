...
#ifndef GAZEBO_PLUGINS__GAZEBO_ROS_P3D_NAMED_HPP_
#define GAZEBO_PLUGINS__GAZEBO_ROS_P3D_NAMED_HPP_
...
/**
  ...
  \code{.xml}
    <plugin name="gazebo_ros_force" filename="libgazebo_ros_force.so">
      ...
      <!--- Specify child frame id (defaults to body name) -->
      <child_frame>carrier</child_frame>

    </plugin>
  \endcode
*/
class GazeboRosP3DNamed : public gazebo::ModelPlugin
{
public:
  /// Constructor
  GazeboRosP3DNamed();
...
private:
  ...
  std::unique_ptr<GazeboRosP3DNamedPrivate> impl_;
};

}  // namespace gazebo_plugins

#endif  // GAZEBO_PLUGINS__GAZEBO_ROS_P3D_NAMED_HPP_