...
#ifndef GAZEBO_PLUGINS__GAZEBO_ROS_FORCE_BASED_MOVE_HPP_
#define GAZEBO_PLUGINS__GAZEBO_ROS_FORCE_BASED_MOVE_HPP_
...
class GazeboRosForceBasedMove : public gazebo::ModelPlugin
{
public:
  /// Constructor
...
private:
  ...
  std::unique_ptr<GazeboRosForceBasedMovePrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  // GAZEBO_PLUGINS__GAZEBO_ROS_FORCE_BASED_MOVE_HPP_
