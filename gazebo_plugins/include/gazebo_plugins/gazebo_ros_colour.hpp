...
#ifndef GAZEBO_PLUGINS__GAZEBO_ROS_COLOUR_HPP_
#define GAZEBO_PLUGINS__GAZEBO_ROS_COLOUR_HPP_
...
class GazeboRosColour : public gazebo::VisualPlugin
{
public:
  /// Constructor
  GazeboRosColour();
...
private:
  ...
  std::unique_ptr<GazeboRosColourPrivate> impl_;
};
}  // namespace gazebo_plugins
