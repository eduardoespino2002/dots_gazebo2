...
#ifndef GAZEBO_PLUGINS__GAZEBO_ROS_LIFTER_HPP_
#define GAZEBO_PLUGINS__GAZEBO_ROS_LIFTER_HPP_
...
class GazeboRosLifter : public gazebo::ModelPlugin
{
public:
  /// Constructor
  GazeboRosLifter();
...
private:
  ...
  std::unique_ptr<GazeboRosLifterPrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  // GAZEBO_PLUGINS__GAZEBO_ROS_LIFTER_HPP_
